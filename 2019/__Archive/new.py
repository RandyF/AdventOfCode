...
DEC03_TV1As = 'R8,U5,L5,D3'

DEC03_TV1Bs = 'U7,R6,D4,L4'
...
DEC03_TV2As = 'R75,D30,R83,U83,L12,D49,R71,U7,L72'

DEC03_TV2Bs = 'U62,R66,U55,R34,D71,R55,D58,R83'
...
DEC03_TV3As = 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51'

DEC03_TV3Bs = 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7'
...
def GenWire( WireString ):
    ...
    for tSeg in WireString:

        tDir = tSeg[0]

        tLen = int(tSeg[1:])

        #print tSeg, tDir, tLen
        ...
        for tPoint in range(tLen):
            ...
            tCurMeta[3] = DistanceManhattan(tCurPoint)

           

            taCurPoint = tCurPoint[:]

            #print tPoint, tCurPoint, taCurPoint, tCurMeta
    ...
    print "Wire Points: ", len(tWire)#, tWire
    ...
    return lWireA, tdWire

        

    #lWireA.sort(key = DistanceManhattan )

 

[lWireA, dWireA] = GenWire(DEC03_TVA)

[lWireB, dWireB] = GenWire(DEC03_TVB)

 

lsMatches = set(dWireA.keys()).intersection(dWireB.keys())

print "Match Points: ", len(lsMatches)
...
for ptMatch in lsMatches:
    ...
    print dWireA[ptMatch], dWireB[ptMatch],

    lMatchA.append(dWireA[ptMatch])

    lMatchB.append(dWireB[ptMatch])

    print dWireA[ptMatch][0], dWireA[ptMatch][1], dWireA[ptMatch][2], dWireB[ptMatch][2], dWireA[ptMatch][2] + dWireB[ptMatch][2]

   

    tStepTot = dWireA[ptMatch][2] + dWireB[ptMatch][2]
...
lMatchA.sort(key=SortDist)

lMatchB.sort(key=SortDist)

#print lMatchA[0], lMatchA[0][3]

#print lMatchB[0], lMatchB[0][3]

print " ** PART A:  Closest Match = ", lMatchA[0][3], lMatchB[0][3]

print " ** PART B:  Closest Match = ", minSteps